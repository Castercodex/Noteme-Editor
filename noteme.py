...
fileMenu.add_command(
    label="New", accelerator="Ctrl + N", compound="left", command=newfile
)
fileMenu.add_command(
    label="Open", accelerator="Ctrl + O", compound="left", command=openfile
)
fileMenu.add_command(
    label="Save", accelerator="Ctrl + S", compound="left", command=savefile
)
fileMenu.add_command(
    label="Save as", accelerator="Ctrl + Shift + S", compound="left", command=saveasfile
)
...
lineNumberBar = tk.Text(
    root, width=6, takefocus=0, border=0, background="#cbc6c6", state="disabled"
)
lineNumberBar.pack(side="left", fill="y")

# Buttons
newfileBtn = tk.Button(
    frame,
    text="New File",
    bg="#4dec4d",
    height=2,
